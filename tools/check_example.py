...
'crm-dlya-dropshippingu':(
  'CRM для дропшипінгу: замовлення, постачальники і маржа',
  'CRM для дропшипінгу: система обліку замовлень | Devlly',
  'Яка CRM потрібна дропшипперу: облік замовлень від кількох постачальників, статуси відправлень, трек-номери і розрахунок маржі по кожному замовленню.'),
'dropshipping-postachalnyky-ukraina':(
  'Дропшипінг постачальники в Україні: як обрати і працювати',
  'Дропшипінг постачальники України: як обрати | Devlly',
  'Як знайти і перевірити постачальника для дропшипінгу в Україні: умови співпраці, залишки, терміни відправки, повернення і синхронізація прайсів без ручної роботи.'),
'avtomatyzatsiya-dropshipping-aliexpress':(
  'Автоматизація дропшипінгу з AliExpress: замовлення і трекінг',
  'Автоматизація дропшипінгу з AliExpress | Devlly',
  'Як автоматизувати дропшипінг з AliExpress: імпорт товарів, перерахунок цін під курс і комісії, оформлення замовлень у постачальника і трекінг довгої доставки.'),
}
